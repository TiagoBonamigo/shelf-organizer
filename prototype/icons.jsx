// Shared icons — outline style at 14-16px.
const Icon = ({ children, size = 14, className = "", strokeWidth = 1.6 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const Icons = {
  ...
  LockSmall: (props) => (
    <svg viewBox="0 0 16 16" width="9" height="9" fill="currentColor" {...props}>
